...
Here are the `installation <https://github.com/rnd-team-dev/plotoptix/blob/master/gcp_install_gpu.txt>`__ steps so you can save some precious seconds (FFmpeg not included).
